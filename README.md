...
During the game, a sequence of colors will light up on the LED. Your goal is to carefully watch and remember the colors in the correct order. When you are ready to play your turn, press the big button in the middle on your side of the game. This starts your turn. After pressing the big button, repeat the color sequence by pressing the small buttons. Each small button represents a color: red, blue, green, and yellow. Try to press the buttons in the same order as the colors shown on the LED. If you repeat the sequence correctly, you earn a point and move the crown one step forward on the board. The game continues with players taking turns. The first player to move the crown forward five steps wins the game.
...
### 3D hönnun
[kóronur](Sölvi_og_Francheska_Margaret-8.stl)
### 2D hönnun
